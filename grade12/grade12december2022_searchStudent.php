...
$_SESSION['monthYear'] = "grade12_december2022";

$searchStudentSql = "SELECT * FROM grade12_december2022 WHERE section LIKE '%$userSearch%' || student_name LIKE '%$userSearch%' || lrn LIKE '%$userSearch%' ORDER BY section";
