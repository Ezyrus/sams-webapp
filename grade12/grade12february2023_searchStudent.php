...
$_SESSION['monthYear'] = "grade12_february2023";

$searchStudentSql = "SELECT * FROM grade12_february2023 WHERE section LIKE '%$userSearch%' || student_name LIKE '%$userSearch%' || lrn LIKE '%$userSearch%' ORDER BY section";
...
<body>
   ...
   <section class="nav">
      ...
      <div class="title">
         ...
         <div>
            <h3>february 2023</h3>
            <h6>4p's Grade 12 Student Records</h6>
         </div>
   ...
   <section class="log">
      <h3><a href="../adminDashboard/admin_dashboard-gradeLevel.php">Grade 12 > </a><a href="../adminDashboard/admin_dashboard-grade12year2023.php">Year 2023 ></a><a href="grade12february2023.php"> february </a>
      </h3>

      <form action="grade12february2023_searchStudent.php" method="GET">
