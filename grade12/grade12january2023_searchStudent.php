...
$_SESSION['monthYear'] = "grade12_january2023";

$searchStudentSql = "SELECT * FROM grade12_january2023 WHERE section LIKE '%$userSearch%' || student_name LIKE '%$userSearch%' || lrn LIKE '%$userSearch%' ORDER BY section";
...
<body>
   ...
   <section class="log">
      <h3><a href="../adminDashboard/admin_dashboard-gradeLevel.php">Grade 12 > </a><a href="../adminDashboard/admin_dashboard-grade12year2023.php">Year 2023 ></a><a href="grade12january2023.php"> january </a>
      </h3>

      <form action="grade12january2023_searchStudent.php" method="GET">
