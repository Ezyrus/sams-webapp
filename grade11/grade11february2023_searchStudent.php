...
$_SESSION['monthYear'] = "grade11_february2023";

$searchStudentSql = "SELECT * FROM grade11_february2023 WHERE section LIKE '%$userSearch%' || student_name LIKE '%$userSearch%' || lrn LIKE '%$userSearch%' ORDER BY section";
...
<body>
   ...
   <section class="log">
      <h3><a href="../adminDashboard/admin_dashboard-gradeLevel.php">Grade 11 > </a><a href="../adminDashboard/admin_dashboard-grade11year2023.php">Year 2023 ></a><a href="grade11february2023.php"> february </a>
      </h3>

      <form action="grade11february2023_searchStudent.php" method="GET">
