...
$_SESSION['monthYear'] = "grade11_october2022";

$searchStudentSql = "SELECT * FROM grade11_october2022 WHERE section LIKE '%$userSearch%' || student_name LIKE '%$userSearch%' || lrn LIKE '%$userSearch%' ORDER BY section";
