...
function validateLrn() {
  ...
  if (lrnInput.length == 0) {
    ...
    lrnError.innerHTML = "";
    lrnLabel.innerHTML =
      ' <img src="../assets/goodinput.png" alt="goodinput"> ';
    return true;
  }
}
...
function validateName() {
  ...
  if (nameInput.length == 0) {
    ...
    nameError.innerHTML = "Invalid Input detected!";
    nameLabel.innerHTML = '<img src="../assets/badinput.png" alt="badinput"> ';
    return false;
  } else {
    nameError.innerHTML = "";
...
function validateSection() {
  ...
  if (sectionInput.length == 0) {
    ...
    sectionLabel.innerHTML =
      '<img src="../assets/badinput.png" alt="badinput"> ';
    return false;
  } else if (sectionInput.match(/[^A-Za-z0-9-., ]/)) {
    sectionError.innerHTML = "Invalid Input detected!";
    sectionLabel.innerHTML =
      '<img src="../assets/badinput.png" alt="badinput"> ';
    return false;
  } else {
...
function validateEmail() {
  ...
  if (emailInput.length == 0) {
    ...
    return false;
  } else if (emailInput.match(/[^A-Za-z0-9.,@ ]/)) {
    emailError.innerHTML = "Invalid Input detected!";
    emailLabel.innerHTML = '<img src="../assets/badinput.png" alt="badinput"> ';
    return false;
  } else {
...
function validateAddress() {
  ...
  if (addressInput.length == 0) {
    ...
    addressLabel.innerHTML =
      '<img src="../assets/badinput.png" alt="badinput"> ';
    return false;
  } else if (addressInput.match(/[^A-Za-z0-9.,# ]/)) {
    addressError.innerHTML = "Invalid Input detected!";
    addressLabel.innerHTML =
      '<img src="../assets/badinput.png" alt="badinput"> ';
    return false;
  } else {
